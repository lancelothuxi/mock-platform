...
public class LocalCache {
  ...
  @Autowired IMockConfigService mockConfigService;
  @Autowired IMockDataService mockDataService;
  ...
  private void init() {
    ...
    // 订阅消息
    mockConfigChangedTopic.addListener(
        String.class,
        (channel, message) -> {
          MockConfigCacheUpdateMessage request =
              JSON.parseObject(message, MockConfigCacheUpdateMessage.class);

...
import io.github.lancelothuxi.mock.common.utils.file.FileUploadUtils;
import io.github.lancelothuxi.mock.common.utils.file.MimeTypeUtils;
      ...
      if (!file.isEmpty()) {
        String avatar =
            FileUploadUtils.upload(
                RuoYiConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);

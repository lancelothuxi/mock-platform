...
import io.github.lancelothuxi.mock.framework.web.service.ConfigService;
...
public class SysLoginController extends BaseController {
  ...
  public String login(HttpServletRequest request, HttpServletResponse response, ModelMap mmap) {
    ...
    // 是否开启用户注册
    mmap.put(
        "isAllowRegister", Convert.toBool(configService.getKey("sys.account.registerUser"), false));
    return "login";
  }

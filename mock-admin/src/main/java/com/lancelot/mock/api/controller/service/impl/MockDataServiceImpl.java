...
import com.lancelot.mock.api.controller.mapper.MockDataMapper;
import com.lancelot.mock.api.controller.mock.MockExpression;
...
public class MockDataServiceImpl implements IMockDataService {
    ...
    public MockData selectMockDataResult(MockConfig mockConfig) {
        return mockDataMapper.selectMockDataResult(mockConfig);
    }

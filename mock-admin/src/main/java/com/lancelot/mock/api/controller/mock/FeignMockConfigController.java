...
import com.lancelot.mock.api.controller.service.IMockDataService;
...
import static com.lancelot.mock.api.controller.mock.MockUtil.getMockData;
...
public class FeignMockConfigController extends BaseController
{
    ...
    public TableDataInfo list(MockConfig MockConfig)
    {
        ...
        List<com.lancelot.mock.api.controller.domain.MockConfig> list = mockConfigService.fuzzlySelectMockConfigList(MockConfig);

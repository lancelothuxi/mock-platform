package com.lancelot.mock.tool;
...
public class NativeLoader {
    ...
    private static void loadFileNative(File file, String ext) {
        ...
        if (file.canRead() && file.getName().endsWith(ext)) {
            try {
                ...
                logger.info("加载native文件 :" + file + "成功!!");
            } catch (UnsatisfiedLinkError e) {
                logger.info("加载native文件 :" + file + "失败!!请确认操作系统是X86还是X64!!!");
            }
        }
    }
    ...
    private static void loadJarNative(JarEntry jarEntry) throws IOException, ClassNotFoundException {
        ...
        try {
            ...
            logger.info("加载native文件 :" + tempFile + "成功!!");
        } catch (UnsatisfiedLinkError e) {
            logger.info("加载native文件 :" + tempFile + "失败!!请确认操作系统是X86还是X64!!!");
        }

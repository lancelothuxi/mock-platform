...
import io.github.lancelothuxi.mock.common.core.domain.Ztree;
import io.github.lancelothuxi.mock.common.core.domain.entity.SysDept;
...
import io.github.lancelothuxi.mock.system.mapper.SysDeptMapper;
import io.github.lancelothuxi.mock.system.service.ISysDeptService;
...
public class SysDeptServiceImpl implements ISysDeptService {
  ...
  public List<Ztree> selectDeptTreeExcludeChild(SysDept dept) {
    ...
    if (excludeId.intValue() > 0) {
      depts.removeIf(
          d ->
              d.getDeptId().intValue() == excludeId

...
(
    ...
    data             varchar(1000)                         null comment '参数数据值',
    enabled          char        default '0'               null comment '开关（1开启 0关闭）',
    created_at       datetime    default CURRENT_TIMESTAMP not null comment '创建时间',
    updated_at       datetime    default CURRENT_TIMESTAMP not null on update CURRENT_TIMESTAMP comment '更新时间',
    match_data_id    int(12)                               null comment '匹配参数数据的id',
    appliaction_name varchar(128)                          null comment '应用名',
    ...
    direct_match int null default 0 comment '直接匹配',
    constraint mock_rule_uk
        unique (interface_name, method_name, group_name, version, appliaction_name)
)
comment '服务mock方法表' charset = utf8;
...
(
    ...
    mock_config_id  varchar(255)                           null comment 'mock规则配置表的id',
    mock_req_params varchar(1024)                          null comment 'mock请求参数匹配规则',
    ...
    expected_value  varchar(100) default ''                not null comment '根据jsonpath eval后的实际值',
    enabled         int          default 1                 not null comment '是否启用'
)
comment 'mock配置关联响应数据表' charset = utf8;
create index mock_data_mock_config_id_index
    on mock_data (mock_config_id);


INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, url, target, menu_type, visible, is_refresh, perms, icon, create_by, create_time, update_by, update_time, remark) VALUES (2000, 'mock管理', 0, 5, '#', 'menuItem', 'M', '0', '1', '', 'fa fa-address-book', 'admin', '2023-05-09 20:53:27', 'admin', '2023-06-03 11:38:51', '');
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, url, target, menu_type, visible, is_refresh, perms, icon, create_by, create_time, update_by, update_time, remark) VALUES (2001, 'dubboMock', 2000, 1, 'mock/dubbo/config?type=dubbo', 'menuItem', 'C', '0', '0', '', 'fa fa-birthday-cake', 'admin', '2023-05-09 20:56:55', 'admin', '2023-06-03 11:41:00', '');
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, url, target, menu_type, visible, is_refresh, perms, icon, create_by, create_time, update_by, update_time, remark) VALUES (2002, '新增mock配置', 2001, 1, '#', 'menuItem', 'F', '0', '1', '', '#', 'admin', '2023-05-09 21:10:43', 'admin', '2023-05-10 09:36:40', '');
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, url, target, menu_type, visible, is_refresh, perms, icon, create_by, create_time, update_by, update_time, remark) VALUES (2003, '接口mock配置修改', 2001, 2, '#', 'menuItem', 'F', '0', '1', 'mock:rule:edit', '#', 'admin', '2023-05-09 21:14:12', '', null, '');
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, url, target, menu_type, visible, is_refresh, perms, icon, create_by, create_time, update_by, update_time, remark) VALUES (2004, 'mock配置删除', 2001, 3, '#', 'menuItem', 'F', '0', '1', 'mock:rule:remove', '#', 'admin', '2023-05-09 21:15:28', '', null, '');
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, url, target, menu_type, visible, is_refresh, perms, icon, create_by, create_time, update_by, update_time, remark) VALUES (2009, 'dubboRestMock', 2000, 2, 'mock/dubbo/config?type=dubborest', 'menuItem', 'C', '0', '1', '', 'fa fa-bath', 'admin', '2023-06-03 11:40:01', 'admin', '2023-06-03 11:40:46', '');
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, url, target, menu_type, visible, is_refresh, perms, icon, create_by, create_time, update_by, update_time, remark) VALUES (2010, 'feignMock', 2000, 3, 'mock/dubbo/config?type=feign', 'menuItem', 'C', '0', '1', null, 'fa fa-automobile', 'admin', '2023-06-03 11:40:31', '', null, '');

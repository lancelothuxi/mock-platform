...
VALUES (2000, 'mock管理', 0, 5, '#', 'menuItem', 'M', '0', '1', '', 'fa fa-address-book', 'admin', '2023-05-09 20:53:27',
        'admin', '2023-06-03 11:38:51', '');
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, url, target, menu_type, visible, is_refresh, perms,
                      icon, create_by, create_time, update_by, update_time, remark)
VALUES (2001, 'dubboMock', 2000, 1, 'mock/dubbo/config?type=dubbo', 'menuItem', 'C', '0', '0', '',
        'fa fa-birthday-cake', 'admin', '2023-05-09 20:56:55', 'admin', '2023-06-03 11:41:00', '');
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, url, target, menu_type, visible, is_refresh, perms,
                      icon, create_by, create_time, update_by, update_time, remark)
VALUES (2002, '新增mock配置', 2001, 1, '#', 'menuItem', 'F', '0', '1', '', '#', 'admin', '2023-05-09 21:10:43', 'admin',
        '2023-05-10 09:36:40', '');
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, url, target, menu_type, visible, is_refresh, perms,
                      icon, create_by, create_time, update_by, update_time, remark)
VALUES (2003, '接口mock配置修改', 2001, 2, '#', 'menuItem', 'F', '0', '1', 'mock:rule:edit', '#', 'admin',
        '2023-05-09 21:14:12', '', null, '');
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, url, target, menu_type, visible, is_refresh, perms,
                      icon, create_by, create_time, update_by, update_time, remark)
VALUES (2004, 'mock配置删除', 2001, 3, '#', 'menuItem', 'F', '0', '1', 'mock:rule:remove', '#', 'admin',
        '2023-05-09 21:15:28', '', null, '');

INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, url, target, menu_type, visible, is_refresh, perms,
                      icon, create_by, create_time, update_by, update_time, remark)
VALUES (2010, 'feignMock', 2000, 3, 'mock/dubbo/config?type=feign', 'menuItem', 'C', '0', '1', null, 'fa fa-automobile',
        'admin', '2023-06-03 11:40:31', '', null, '');
...
(
    ...
    is_valid int default 0 not null comment '是否生效',
    content varchar(4096) default '' not null comment 'kuebeconfig文件内容',
    create_time timestamp default current_timestamp not null comment '创建时间',
    update_time timestamp default current_timestamp not null comment '更新时间',
    constraint kube_config_pk
        primary key (id)
);

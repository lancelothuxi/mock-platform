package io.github.lancelothuxi.mock.server.common.utils.file;
...
class FileUploadUtilsTest {
    ...
    void testSaveFileToLocal() {
        ...
        Assertions.assertEquals(ErrorCode.Internal.INVALID_PARAMETER, exceptionWithNullSubDir.getErrorCode());
        Assertions.assertEquals(ErrorCode.Internal.INVALID_PARAMETER, exceptionWitEmptyFileName.getErrorCode());
    }
    ...
    void testIsAllowedUploadWhenFileNameTooLong() {
        ...
        Assertions.assertEquals(ErrorCode.Business.UPLOAD_FILE_NAME_EXCEED_MAX_LENGTH, exception.getErrorCode());
    }
    ...
    void testIsAllowedUploadWhenFileTooBig() {
        ...
        ApiException exception = Assertions.assertThrows(ApiException.class,
            () -> FileUploadUtils.isAllowedUpload(fileMock, null));
        Assertions.assertEquals(ErrorCode.Business.UPLOAD_FILE_SIZE_EXCEED_MAX_SIZE, exception.getErrorCode());
    }

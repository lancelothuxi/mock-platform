package io.github.lancelothuxi.mock.server.admin.config;


import io.github.lancelothuxi.mock.server.admin.AgileBootAdminApplication;
...
public class AgileBootConfigTest {
    ...
    public void testConfig() {
        ...
        Assertions.assertEquals(fileBaseDir + "\\import",
            AgileBootConfig.getFileBaseDir() + File.separator + Constants.UploadSubDir.IMPORT_PATH);
        Assertions.assertEquals(fileBaseDir + "\\avatar",
            AgileBootConfig.getFileBaseDir() + File.separator + Constants.UploadSubDir.AVATAR_PATH);
        Assertions.assertEquals(fileBaseDir + "\\download",
            AgileBootConfig.getFileBaseDir() + File.separator + Constants.UploadSubDir.DOWNLOAD_PATH);
        Assertions.assertEquals(fileBaseDir + "\\upload",
            AgileBootConfig.getFileBaseDir() + File.separator + Constants.UploadSubDir.UPLOAD_PATH);
    }

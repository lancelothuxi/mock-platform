...
class RoleModelTest {
    ...
    void testCheckRoleNameUnique() {
        ...
        Assertions.assertEquals(ErrorCode.Business.ROLE_NAME_IS_NOT_UNIQUE, exception.getErrorCode());
    ...
    void testCheckRoleCanBeDelete() {
        ...
        Assertions.assertEquals(ErrorCode.Business.ROLE_ALREADY_ASSIGN_TO_USER, exception.getErrorCode());
    }
    ...
    void testCheckRoleKeyUnique() {
        ...
        Assertions.assertEquals(ErrorCode.Business.ROLE_KEY_IS_NOT_UNIQUE, exception.getErrorCode());
    ...
    void testGenerateDeptIdSetWhenDuplicated() {
        ...
        Assertions.assertEquals(ErrorCode.Business.ROLE_DATA_SCOPE_DUPLICATED_DEPT, exception.getErrorCode());
    }

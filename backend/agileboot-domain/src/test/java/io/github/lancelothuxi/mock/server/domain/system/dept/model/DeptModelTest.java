...
class DeptModelTest {
    ...
    void testCheckDeptNameUnique() {
        ...
        Assertions.assertEquals(ErrorCode.Business.DEPT_NAME_IS_NOT_UNIQUE, exception.getErrorCode());
    }
    ...
    void testCheckParentIdConflict() {
        ...
        Assertions.assertEquals(ErrorCode.Business.DEPT_PARENT_ID_IS_NOT_ALLOWED_SELF, exception.getErrorCode());
    }
    ...
    void testCheckHasChildDept() {
        ...
        Assertions.assertEquals(ErrorCode.Business.DEPT_EXIST_CHILD_DEPT_NOT_ALLOW_DELETE, exception.getErrorCode());
    }
    ...
    void testCheckDeptAssignedToUsers() {
        ...
        Assertions.assertEquals(ErrorCode.Business.DEPT_EXIST_LINK_USER_NOT_ALLOW_DELETE, exception.getErrorCode());
    }
    ...
    void testGenerateAncestorsWhenParentDeptNotExist() {
        ...
        Assertions.assertEquals(ErrorCode.Business.DEPT_PARENT_DEPT_NO_EXIST_OR_DISABLED, exception.getErrorCode());
    }
    ...
    void testCheckStatusAllowChangeWhenDisableButHasChildDept() {
        ...
        Assertions.assertEquals(ErrorCode.Business.DEPT_STATUS_ID_IS_NOT_ALLOWED_CHANGE, exception.getErrorCode());
    }

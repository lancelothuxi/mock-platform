...
class MenuModelTest {
    ...
    void testCheckMenuNameUnique() {
        ...
        Assertions.assertEquals(ErrorCode.Business.MENU_NAME_IS_NOT_UNIQUE, exception.getErrorCode());
    }
...
//        externalWithoutHttpPrefix.setIsExternal(true);
        ...
        Assertions.assertEquals(ErrorCode.Business.MENU_EXTERNAL_LINK_MUST_BE_HTTP, exception.getErrorCode());
    }
    ...
    void testCheckParentIdConflict() {
        ...
        Assertions.assertEquals(ErrorCode.Business.MENU_PARENT_ID_NOT_ALLOW_SELF, exception.getErrorCode());
    }
    ...
    void testCheckHasChildMenus() {
        ...
        Assertions.assertEquals(ErrorCode.Business.MENU_EXIST_CHILD_MENU_NOT_ALLOW_DELETE, exception.getErrorCode());
    ...
    void testCheckMenuAlreadyAssignToRole() {
        ...
        Assertions.assertEquals(ErrorCode.Business.MENU_ALREADY_ASSIGN_TO_ROLE_NOT_ALLOW_DELETE, exception.getErrorCode());
    }
}

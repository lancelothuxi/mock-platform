...
class UserModelTest {
    ...
    void testCheckUsernameIsUnique() {
        ...
        Assertions.assertEquals(ErrorCode.Business.USER_NAME_IS_NOT_UNIQUE, exception.getErrorCode());
    ...
    void testCheckPhoneNumberIsUnique() {
        ...
        Assertions.assertEquals(ErrorCode.Business.USER_PHONE_NUMBER_IS_NOT_UNIQUE, exception.getErrorCode());
    ...
    void testCheckEmailIsUnique() {
        ...
        Assertions.assertEquals(ErrorCode.Business.USER_EMAIL_IS_NOT_UNIQUE, exception.getErrorCode());
        Assertions.assertDoesNotThrow(userWithNewNumber::checkPhoneNumberIsUnique);
    }
    ...
    void testCheckCanBeDeleteWhenDeleteItself() {
        ...
        Assertions.assertEquals(ErrorCode.Business.USER_CURRENT_USER_CAN_NOT_BE_DELETE, exception.getErrorCode());
    }
    ...
    void testModifyPasswordWhenOldNewPasswordSame() {
        ...
        ApiException exception = assertThrows(ApiException.class, () -> userModel.modifyPassword(passwordCommand));
        Assertions.assertEquals(ErrorCode.Business.USER_NEW_PASSWORD_IS_THE_SAME_AS_OLD, exception.getErrorCode());
    }
